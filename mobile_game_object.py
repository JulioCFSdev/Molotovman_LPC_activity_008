...
class Draw_Players:
    ...
    def draw_soviet(self, add_x, add_y, last_key_pressed):
        ...
        pygame.draw.rect(screen,(255,0, 0), [pos_x_s, pos_y_s, 50, 70],2)
        obj_rect = pygame.Rect(pos_x_s, pos_y_s, 50, 70)
    ...
    def draw_american(self, add_x, add_y, last_key_pressed):
        ...
        pygame.draw.rect(screen,(255,0,0), [pos_x_a, pos_y_a,50 ,70], 2)
        obj_rect = pygame.Rect(pos_x_a, pos_y_a, 50, 70)
